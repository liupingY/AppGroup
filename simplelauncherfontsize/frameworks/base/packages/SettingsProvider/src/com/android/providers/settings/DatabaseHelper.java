...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /** prize-add-flip_silent-by-zhongweilin-start*/
            loadBooleanSetting(stmt, Settings.System.PRIZE_FLIP_SILENT,R.bool.def_prize_flip_silent_enabled);
            loadBooleanSetting(stmt, Settings.System.PRIZE_SMART_DIALING,R.bool.def_prize_smart_dialing_enabled);
            loadBooleanSetting(stmt, Settings.System.PRIZE_SMART_ANSWER_CALL,R.bool.def_prize_smart_answer_call_enabled);
            loadBooleanSetting(stmt, Settings.System.PRIZE_POCKET_MODE,R.bool.def_prize_pocket_mode_enabled);
            loadBooleanSetting(stmt, Settings.System.PRIZE_ANTIFAKE_TOUCH,R.bool.def_prize_antifake_touch_enabled);
            loadIntegerSetting(stmt, Settings.System.PRIZE_SALES_STATIS,R.integer.def_prize_sales_statis);
            ...
            /** prize-add-flip_silent-by-zhongweilin-end*/
			
			/** prize-add-flip_silent-by-huangdianjun-start*/
			...
			/** prize-add-flip_silent-by-huangdianjun-end*/
			...
			/**prize-simplelauncher-liup-20160111-start*/	
			loadIntegerSetting(stmt, Settings.System.PRIZE_SIMPLELAUNCHER_FONTSIZE_CUSTOM,R.integer.def_prize_simplelauncher_fontsize_custom);	
			/**prize-simplelauncher-liup-20160111-end*/	

            /**prize-time_12_24-huangdianjun-20150731-start*/
            loadStringSetting(stmt, Settings.System.TIME_12_24,R.string.time_12_24);
            /**prize-time_12_24-huangdianjun-20150731-end*/
			
			/** prize-add-by-yanghao-20150908-start*/
			loadSetting(stmt, "battery_percentage_enabled", PrizeOption.PRIZE_SYSTEMUI_BATTERY_METER ? 1:0);		
			/**prize-add-by-yanghao-20150908-end*/
			
            ///M: load MTK new add System providers.
            mUtils.loadCustomSystemSettings(stmt);

            //add for nav bar style. prize-linkh-20150818
            if(mContext.getResources().getBoolean(com.prize.internal.R.bool.support_navbar_style)) {
