...
public class LauncherModel extends BroadcastReceiver {
    static final boolean DEBUG_LOADERS = LauncherLog.DEBUG_LOADERS;
            ...
            public void run() {
                ...
                synchronized(sBgLock) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        if ((LauncherModel.shortcutExists(context, name, launchIntent)|| LauncherModel.shortcutExistsFromAppStore(context,name,fromAppstore))) {
                        	if (a != null) {
...
//                        String packageName = shortcutInfo.getIntent().getComponent().getPackageName();
    ...
    static void moveItemInDatabase(Context context, final ItemInfo item, final long container,
        ...
        values.put(LauncherSettings.Favorites.PACKAGE_NAME, item.progress);
        values.put(LauncherSettings.Favorites.DOWN_PROGRESS, item.packageName);
	 ...
	 */
	static boolean shortcutExistsFromAppStore(Context context, String title,int fromAppstore) {
		final ContentResolver cr = context.getContentResolver();
		boolean result = false;
		if(title ==null) {
			return result;
        ...
        private boolean loadWorkspace() {
            ...
            synchronized (sBgLock) {
                ...
                if (loadedOldDb) {
                    ...
                    for(long id=0;id<this.mContext.getResources().getInteger(R.integer.min_workspaces);id++) {
