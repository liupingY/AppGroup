...
//A by zhouerlong
   public AttributesInfo  loadAttributesInfo(XmlPullParser parser) { 
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            boolean isexistsFile = FileUtils.isexistsFile(mContext, FILENAME);
...
//A by zhouerlong
        		...
        		if (isexistsFile) {
            		  ...
            		  InputStream input;
                           input = FileUtils.loadXmlFile(FILENAME);
                    if (input != null)
...
//A by zhouerlong
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        if (isexistsFile) {
                              ...
                              titleResId = info.title;
                        }else {

                            titleResId =  a.getResourceId(R.styleable.Favorite_title, -1);	
                        }
                        if (titleResId != -1) {
