...
public interface DropTarget {
    ...
    class DragObject {
         ...
         * 批量整理 所有选中图标拖动源图标控件
         */
        public HashMap <View,DragView> dragViews =new HashMap<>();
        

        public HashMap <DragView,AnimationRingForDragview> mDragAnimations =new HashMap<>();
    ...
    void onFristEnter(DragObject dragObject); 
