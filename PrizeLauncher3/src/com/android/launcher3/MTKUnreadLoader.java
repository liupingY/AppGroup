...
public class MTKUnreadLoader extends BroadcastReceiver {
            ...
            if (mCallbacks != null && componentName != null && unreadNum != -1) {
                ...
                if (index >= 0) {
                    ...
                    if (ret ||title !=null) {
                        ...
                        if (callbacks != null) {
                            callbacks.bindComponentUnreadChanged(componentName, unreadNum,title);
                        }
                    }
                }
            }
    ...
    static void drawUnreadEventIfNeed(Canvas canvas, View icon) {
        ...
        if (info != null && (info.unreadNum > 0|| info.title != null)) {
    ...
    public interface UnreadCallbacks {
         ...
         * @param unreadNum
         */
        void bindComponentUnreadChanged(ComponentName component, int unreadNum,String title);
