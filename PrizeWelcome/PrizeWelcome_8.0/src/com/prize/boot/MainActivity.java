...
public class MainActivity extends Activity {
	...
	private void initStep() {
		Log.i(TAG, "MainActivity initStep() mCurrentStep=" + mCurrentStep);
        /*if (mIsStepInitiated) {
            return;
        }
        ...
        /*prize-change-bugid:53590-yangming-2018_4_3-start*/
        /*if (mCurrentStep == -1) {
            nextActivity(true);
        } else {
        	transtActivity();
        ...
        nextActivity(true);
        /*prize-change-bugid:53590-yangming-2018_4_3-end*/
    }
