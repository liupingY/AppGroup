...
public final class LruDiskCache {
    ...
    private static final long LIMIT_SIZE = 1024L * 1024L * 80L; // 限制最多80M文件

    private static final int LOCK_WAIT = 1000 * 3; // 3s
    
    private static final String CACHE_DIR_NAME = "left_cache";
    
    private static final String TEMP_FILE_SUFFIX = ".prz";
