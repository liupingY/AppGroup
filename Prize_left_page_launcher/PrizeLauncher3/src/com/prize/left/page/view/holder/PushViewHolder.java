 ...
 * 常用推送Holder
 */
public class PushViewHolder extends RecyclerView.ViewHolder implements
	...
	public PushViewHolder(View v) {
		super(v);
		mCtx = v.getContext();
		((ViewGroup)imgRefresh.getParent()).setVisibility(View.GONE);
	...
	public void setModel(PushModel m) {
		mModel = m;
	}
	...
	private void dealTypeOthers() {
		...
		if (min > 0) {
			for (; startIndex < min; startIndex++) {
				...
				AnimFrameLayout frame = (AnimFrameLayout) contents
