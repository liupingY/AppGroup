...
//        mLayout.setBackgroundColor(Color.GRAY);
        mLayout.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.rect_gray));
        
        int w=(int) ((int) context.getResources().getDisplayMetrics().widthPixels / 1.2);
