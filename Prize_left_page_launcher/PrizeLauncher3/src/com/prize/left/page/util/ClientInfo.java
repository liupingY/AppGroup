...
public class ClientInfo {
	...
	private final static boolean ISTHIRD = false;
	/**
	 * 获取手机的信息
	 */
	private ClientInfo(Context context) {
		...
		//
		String dChannel = Utilities.getChannel();
		if(dChannel!=null) {
			channel=dChannel;
		}
		channel = getAppMetaData(packageManager);
		LogUtil.i("channelCode-->" + channel);
	...
	public String toString() {
		return "ClientInfo [packageName=" + packageName + ", androidVersion="
				+ androidVersion + ", androidVerName=" + androidVerName
				+ ", appVersionCode=" + appVersionCode + ", appVersion="
				+ appVersion + ", newVersionCode=" + newVersionCode + ", cpu="
				+ cpu + ", brand=" + brand + ", model=" + model + ", imei1="
				+ imei1 + ", imei2=" + imei2 + ", imei=" + imei
				+ ", clientStartTime=" + clientStartTime + ", imsi=" + imsi
				...
				+ mac + ", sdCardSize=" + sdCardSize + ", language=" + language
				+ ", userId=" + userId + ", latitude=" + latitude
				+ ", longitude=" + longitude + ", position=" + position
				+ ", sn=" + sn + ", mobile=" + mobile + ", netStatus="
				+ netStatus + ", tid=" + tid + ", address=" + address
				+ ", country=" + country + "]";
	}
	 ...
	 * @return void
	 */
	public static void initClientInfo(Context ctx) {
		getInstance(ctx);
	}
