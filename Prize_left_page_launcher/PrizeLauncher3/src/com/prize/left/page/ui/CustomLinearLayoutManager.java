...
public class CustomLinearLayoutManager extends LinearLayoutManager {
    ...
    private static final int DEFAULT_CHILD_SIZE = 0;
...
//                    width = widthSize;
    ...
    private void measureScrapChild(RecyclerView.Recycler recycler, int pos, int widthSpec, int heightSpec, int[] measuredDimension) {
