...
//    private AppFilter mAppFilter;
    ...
    private LauncherAppState() {
        ...
        mIconCache = IconCache.getInstace(sContext);

//        mAppFilter = AppFilter.loadByName(sContext.getString(R.string.app_filter_class));
        mModel = LauncherModel.getInstace(this, sContext);//new LauncherModel(this, mIconCache);
    ...
    LauncherModel setLauncher(Launcher launcher) {
        ...
        if(mModel.getCallBacks()!=null&&mModel.getCallBacks().get()!=null) {
        	if(launcher!=null&&!mModel.getCallBacks().get().equals(launcher)) {
        		LogUtils.i("zhouerlong", "不等于+ffffffxxx");
                Launcher l =	(Launcher) mModel.getCallBacks().get();
                l.finish();
        	}
        }
