...
public class ItemConfiguration {
    ...
    public void print() {
        ...
        public void prints() {
        	...
        	resort(4,AlignmentState.UP);
        	  for (Entry<View, CellAndSpan> v: items) {
        		  CellAndSpan c= v.getValue();
                  int x=c.x;
                  int y = c.y;
                  if (v != null) {
                	  if (v.getKey() instanceof TextView) {
                		  try {
                              String title = (String) ((TextView)v.getKey()).getText();
                              LogUtils.i("zhouerlong", "print:cellANdSpanInfo----ssssssss-- "+title+"--["+x+","+y+"]");
						} catch (Exception e) {
