...
public class PrizeAsyncImageView extends AsyncImageView {

	public PrizeAsyncImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	static void drawSelect(Canvas canvas, View icon, int w, int h) {
		if (icon.isSelected()) {
			...
			int unreadMarginRight = unreadBgWidth;
