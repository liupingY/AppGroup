...
public class Hotseat extends FrameLayout implements OLThemeChangeListener{
   ...
   public CellLayout getLayout() {
    ...
    public static HotseatDragState mDragState = HotseatDragState.NONE;
    ...
    public void OnEnterHotseat(View child) {
    	LogUtils.i("zhouerlong", "OnEnterHotseat: dddddd");
//    	reLayout();
    	mDragItemView = child;
	...
	public void setDragState(HotseatDragState mDragState) {
    ...
    public void OnExitHotseat(View dragItemView) {
    	if(dragItemView instanceof FolderIcon) {
    		CellLayout.LayoutParams l = (CellLayout.LayoutParams) dragItemView.getLayoutParams();
    		l.tmpCellX=l.cellX;
    		l.tmpCellY=l.cellY;
    	}
    ...
    protected void onFinishInflate() {
        ...
        resetLayout();
        mVisibleCount = LauncherModel.getHotseats(mContext);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
    		...
    		mLauncher.requestDisallowInterceptTouchEventByScrllLayout(true);
	...
	*/}
	private Bitmap getLqThemeHotseatApp() {
		...
		if (LqShredPreferences.isLqtheme(getContext())) {
			 bitmap = IconCache.getLqIcon(componentName, null, true, "");
		}
		return bitmap;
	}
