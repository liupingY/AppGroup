...
public class ItemInfo {
   ...
   public  long id = NO_ID;
    ...
    public boolean select=false;//文件夹编辑状态
    
    public int firstInstall=0;
    
    public int recommd_dis = 1;
   ...
   public int unreadNum = 0;
    ...
    void onAddToDatabase(ContentValues values) { 
        ...
        values.put(LauncherSettings.Favorites.RECOMMD_DIS, recommd_dis);
        values.put(LauncherSettings.Favorites.CONFIG_NAME, configName);
    ...
    void updateValuesRecommdDis(ContentValues values,int dis) {
        values.put(LauncherSettings.Favorites.RECOMMD_DIS, dis);
