...
public class InstallShortcutReceiver extends BroadcastReceiver {
            ...
            if (strings != null) {
                ...
                while (newStringsIter.hasNext()) {
                    ...
                    try {
                        ...
                        if(Launcher.isSupportClone&&launchIntent.getAppInstanceIndex()!=1) {
                        	continue;
                        }
    ...
    public void onReceive(Context context, Intent data) {
		...
		if (intent.getData() != null
				&&(!intent.getData().toString()
						.contains("com.android.contacts")&&!intent.getData().toString()
						.contains("com.prize.appcenter")&&!intent.getData().toString()
						.contains("com.tencent.mm"))) {
        	return ;
        }
		if(intent!=null&&!intent.toString().contains("com.android.contacts")&&!intent.toString().contains("com.prize.appcenter")&&!intent.toString().contains("com.tencent.mm")) {
			return;
		}
		if (intent.getPackage() != null) {
			if (!intent.getPackage().contains("com.android.contacts")
					&& !intent.getPackage().contains("com.prize.appcenter")
					&& !intent.getPackage().contains("com.tencent.mm")) {
				return;
			}
		}
		if(intent.getComponent() != null
				&&(!intent.getComponent().getPackageName()
						.contains("com.android.contacts")&&!intent.getComponent().getPackageName()
						.contains("com.prize.appcenter")&&!intent.getComponent().getPackageName()
						.contains("com.tencent.mm"))) {
			return ;
		}
	...
	public static final String QQ_APP = "com.tencent.mobileqq";
	public static final String WEIBO_APP = "com.sina.weibo";
	
	public static final String EXTRA_FROM_SHORCUT = "from_shorcut";
	public static final String ACTION_INSTALL_SHORCUT = "com.android.launcher.action.INSTALL_SHORTCUT";
	public static final String ACTION_UNINSTALL_SHORCUT = "com.android.launcher.permission.UNINSTALL_SHORTCUT";
    
    
	public static void createShortCut(Context context,Bitmap icon,Intent intent,String shortcutName,Intent launcherIntent){
	        // Queue the item up for adding if launcher has not loaded properly yet
	        LauncherAppState.setApplicationContext(context.getApplicationContext());
	        LauncherAppState app = LauncherAppState.getInstance();
	        boolean launcherNotLoaded = (app.getDynamicGrid() == null);
	        PendingInstallShortcutInfo info = new PendingInstallShortcutInfo(intent, shortcutName, launcherIntent);
	        info.icon = icon;
	        info.name = shortcutName;

	        info.iconResource  = intent.getParcelableExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE);;
