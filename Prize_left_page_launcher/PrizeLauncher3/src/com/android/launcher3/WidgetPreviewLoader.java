...
public class WidgetPreviewLoader {
    ...
    public void setPreviewSize(int previewWidth, int previewHeight,
        ...
        mPreviewBitmapWidth = Math.abs(previewWidth);
        //M by zhouerlong
        mPreviewBitmapHeight = Math.abs(previewHeight);
        //M by zhouerlong
    ...
    public static String getObjectPackage(Object o) {
        if (o instanceof AppWidgetProviderInfo) {
        ...
        new AsyncTask<Void, Void, Void>() {
            public Void doInBackground(Void ... args) {
                ...
                try {
                    ...
                    LauncherLog.e(TAG, "removePackageFromDb: Error delete", e);
                }
                synchronized(sInvalidPackages) {
        ...
        new AsyncTask<Void, Void, Void>() {
            public Void doInBackground(Void ... args) {
                ...
                try {
                    ...
                    LauncherLog.e(TAG, "removeItemFromDb: Error delete", e);
                }
                return null;
            }
        }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, (Void) null);
    ...
    public Bitmap generateWidgetPreview(ComponentName provider, int previewImage,
        ...
        if (widgetPreviewExists) {
            ...
            c.setBitmap(null);
            if(shader!=null&&shader.mBitmap!=null&&!shader.mBitmap.isRecycled()) {
            	shader.mBitmap.recycle();
            }
