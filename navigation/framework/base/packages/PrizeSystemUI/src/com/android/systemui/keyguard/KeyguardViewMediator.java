...
public class KeyguardViewMediator extends SystemUI {
    ...
    //modify by vlife start ,get StatusBarKeyguardViewManager for unlock
    ...
    private void handleSetOccluded(boolean isOccluded) {
        synchronized (KeyguardViewMediator.this) {
		    ...
		    if(NotificationPanelView.USE_VLIFE && isOccluded){
		    	mStatusBarKeyguardViewManager.hideVlifeKeyguardView();
		    }
			//add by vlife-liufan-2016-08-22-end
		    //add by zookingsoft-20161114-start
		    if (NotificationPanelView.USE_ZOOKING && isOccluded) {
		    	mStatusBarKeyguardViewManager.hideZookingKeyguardView();
		    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case START_KEYGUARD_EXIT_ANIM:
				    //add exitFromKeyguard by vlife-liufan-2016-08-20-start
				    exitFromKeyguard = true;
                    StartKeyguardExitAnimParams params = (StartKeyguardExitAnimParams) msg.obj;
                    handleStartKeyguardExitAnimation(params.startTime, params.fadeoutDuration);
				    exitFromKeyguard = false;
				    //add exitFromKeyguard by vlife-liufan-2016-08-20-end
                    break;
	...
	private boolean exitFromKeyguard = false;//add by vlife-liufan-2016-08-20
    private void handleStartKeyguardExitAnimation(long startTime, long fadeoutDuration) {
        if (DEBUG) {
            Log.d(TAG, "handleStartKeyguardExitAnimation() is called.") ;
        }
		//add by vlife-liufan-2016-08-20-start
        //modify by zookingsoft add "|| NotificationPanelView.USE_ZOOKING"
		if((NotificationPanelView.USE_VLIFE || NotificationPanelView.USE_ZOOKING) && exitFromKeyguard){
			startTime = 0;
			fadeoutDuration = 80;
		}
		//add by vlife-liufan-2016-08-20-end
