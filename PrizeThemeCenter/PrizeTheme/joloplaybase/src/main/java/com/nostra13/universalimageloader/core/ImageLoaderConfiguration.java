...
public final class ImageLoaderConfiguration {
	...
	final DisplayLargerImageOptions defaultDisplayImageOptions;
	 ...
	 * {@link DisplayLargerImageOptions#createSimple() Simple options}</li>
	...
	public static class Builder {
		...
		private DisplayLargerImageOptions defaultDisplayImageOptions = null;
		...
		/**
		 * Sets default {@linkplain DisplayLargerImageOptions display image options}
		 ...
		 * {@linkplain DisplayLargerImageOptions options}<br />
		 * Default value - {@link DisplayLargerImageOptions#createSimple() Simple
		 * options}
		 */
		public Builder defaultDisplayImageOptions(
				DisplayLargerImageOptions defaultDisplayImageOptions) {
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (defaultDisplayImageOptions == null) {
				defaultDisplayImageOptions = DisplayLargerImageOptions.createSimple();
			}
		}
	}
