	...
	public void setActionBarAlpha(int alpha) {
		...
		if (mActionBar != null) {
			...
			if (alpha >= 250) {
				...
				mActionBar.findViewById(R.id.bar_search_topic)
						.setBackgroundResource(
								R.drawable.detail_white_search_selector);
