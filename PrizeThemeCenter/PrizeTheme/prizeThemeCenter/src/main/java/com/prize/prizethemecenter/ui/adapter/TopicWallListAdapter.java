 ...
 */
public class TopicWallListAdapter extends BaseAdapter {
     ...
     * @param activity
     */
    public TopicWallListAdapter(Activity activity){
        context = activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
             convertView = LayoutInflater.from(context).inflate(
                    R.layout.topic_wall_list_layout, null);
        ...
        JLog.i("hu","walllistadapter  state==="+state);
        ...
        if(bean!=null && p!=null&&(tag==null||!tag.equals(p))){
            ImageLoader.getInstance().displayImage(p,viewHolder.wallpaper_logo,
                    UILimageUtil.getHomeThemeDpLoptions(),UILimageUtil.setTagHolder(viewHolder.wallpaper_logo,p));
        }
        return convertView;
    }
