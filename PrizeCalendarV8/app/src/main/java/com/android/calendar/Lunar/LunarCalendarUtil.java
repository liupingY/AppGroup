...
//    	return null;
    ...
    private void initArrays(Resources res) {
        ...
        mSolarTermDays = res.getIntArray(R.array.prize_solar_term_days);
    }
    ...
    private void initStrings(Resources res) {
        ...
        mSolarTermNamesArray = res.getStringArray(R.array.prize_sc_solar_terms);
    ...
    public int getLunarMDStatus(int gregorianYear, int gregorianMonth, int gregorianDay){
    	int lunarDate[] = mLunarAlgorithm.calculateLunarByGregorian(gregorianYear, gregorianMonth,
                gregorianDay);
        if (lunarDate[1] == 1 && lunarDate[2] == 1) {
			return 2;	//New_Year
		}else if (lunarDate[2] == 1) {
			return 1;	//Frist day of the month
		}
        return 0;
    }
