...
public class GeneralPreferences extends PreferenceFragment implements
    ...
    public static final int DEFAULT_START_VIEW = CalendarController.ViewType.MONTH;// prize-public-standard:change
                                                                                   // default
                                                                                   // #ViewType to
                                                                                   // BUTTON_MONTH_INDEX-pengcancan-20160606
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* Delete for V8.0 start */
        /*if (!TextUtils.isEmpty(ringToneUri) &&
                !RingtoneManager.isRingtoneExist(activity, Uri.parse(ringToneUri))) {
        ...
        mHomeTZ.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                if (checkPermissions()) {
                    ...
                    Intent myIntent = new Intent(activity, PermissionDeniedActivity.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /* prize-let vertict adjust to screen's width lixing-2015-7-8-start */ // PreferenceFragment's
                                                                               // not user's
        View listView = view.findViewById(android.R.id.list);
        if (null != listView) {
            listView.setPadding(0, listView.getPaddingTop(), 0, listView.getPaddingBottom());
        }
        /* prize-let vertict adjust to screen's width- lixing-2015-7-8-start */
        return view;
    }
...
//            } 
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (getListView() != null) {
            getListView().setDivider(getActivity().getDrawable(R.drawable.list_divider));
