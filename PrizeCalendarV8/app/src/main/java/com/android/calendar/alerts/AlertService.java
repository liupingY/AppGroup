...
public class AlertService extends Service {
    ...
    void processMessage(Message msg) {
        ...
        if (providerReminder ||
            ...
            // stale notifications.
            /**removed by hekeyi for ring a whole music begin 20171031*/
            /*if (action.equals(Intent.ACTION_PROVIDER_CHANGED) || action.equals(android.provider.CalendarContract.ACTION_EVENT_REMINDER)) {
                try {
                    Thread.sleep(5000);
                } catch (Exception e) {
                    // Ignore.
            ...
            /**removed by hekeyi for ring a whole music end 20171031*/
    ...
    static int processQuery(final Cursor alertCursor, final Context context,
        ...
        int numFired = 0;
        /*
         * M: batch operation to update alert table.
         */
        ...
        try {
            while (alertCursor.moveToNext()) {
                ...
                /*
                 * M: It is no need to do the update if the new state is not
                 * CalendarAlerts.STATE_FIRED
                 */
                if (newState == CalendarAlerts.STATE_FIRED) {
...
//                    cr.update(alertUri, values, null, null);
                    /*
                     * M: Comment out the cr.update, instead put it to an batch
                     * operation to reduce the IPC consumption.
                     */
                    ops.add(ContentProviderOperation.newUpdate(alertUri).withValues(values).build());
                }
            ...
            /*
             * M: Do the batch to update the alert table.
             */
            if (ops.size() > 0) {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            {
                Intent myIntent = new Intent(AlertService.this, PermissionDeniedActivity.class);
