...
public class AgendaAdapter extends ResourceCursorAdapter {
    ...
    static class ViewHolder {
        ...
        boolean grayed;
        int julianDay;
        /** prize-update event layout-wanzhijuan-2015-7-8-start */
        View divider;
        /** prize-update event layout-wanzhijuan-2015-7-8-end */
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (holder == null) {
            ...
            /** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-start */
            holder.dayStatus = (CheckBox) view.findViewById(R.id.agenda_item_status);
            /** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-end */
            
            /** prize-update event layout-wanzhijuan-2015-7-8-start */
            holder.divider = view.findViewById(R.id.view_bottom_divider);
            /** prize-update event layout-wanzhijuan-2015-7-8-end */
        }
