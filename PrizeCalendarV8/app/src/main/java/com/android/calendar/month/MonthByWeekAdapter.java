...
public class MonthByWeekAdapter extends SimpleWeeksAdapter {
    ...
    /// @}
    /** M: findbugs fix.PERFORMANCE : URF_UNREAD_FIELD*/
    ...
    protected void onDayTapped(Time day) {
        setDayParameters(day);
         if (mShowAgendaWithMonth || mIsMiniMonth) {
            ...
            if (!mIsMiniMonth) {
                mController.sendEvent(mContext, CalendarController.EventType.GO_TO, day, day, -1, mIsMiniMonth ? CalendarController.ViewType.CURRENT
                        : CalendarController.ViewType.DETAIL, CalendarController.EXTRA_GOTO_DATE
                        | CalendarController.EXTRA_GOTO_BACK_TO_PREVIOUS, null, null);
            } else {
                mController.sendEvent(mContext, CalendarController.EventType.GO_TO, day, day, -1, mIsMiniMonth ? CalendarController.ViewType.CURRENT
                        : CalendarController.ViewType.DETAIL, CalendarController.EXTRA_GOTO_DATE, null, null);
            }
            ///@}
        }
    }
