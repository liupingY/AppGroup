...
//    private boolean mUserScrolled = false;
    ...
    public MonthByWeekFragment(Context context,long initialTime, boolean isMiniMonth) {
        super(initialTime);
        mIsMiniMonth = isMiniMonth;
        mSelectedDay = Utils.getValidTimeInCalendar(context, initialTime);
//		mSelectedDay.set(1, CurrentMonthDay.month, CurrentMonthDay.year);
    ...
    protected void setMonthDisplayed(Time time, boolean updateHighlight) {
        ...
        if (!mIsMiniMonth) {
            controller.sendEvent(this, CalendarController.EventType.UPDATE_TITLE, time, time, mSelectedDay, -1,
