...
public class AttendeesView extends LinearLayout implements View.OnClickListener {
     ...
     * the constructed View object. The object is also stored in {@link EditEventHelper.AttendeeItem#mView}.
     */
    ...
    /**
     * Set up each element in {@link EditEventHelper.AttendeeItem#mView} using the latest information. View
     * object is reused.
     */
