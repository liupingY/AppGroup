...
public class SelectCalendarsSimpleAdapter extends BaseAdapter implements ListAdapter,
    ...
    /*prize-Change the background color-lixing -2015-8-5 -- start*/
    int prize_account_bg_color;
    /*prize-Change the background color-lixing -2015-8-5 -- end*/
    ...
    public SelectCalendarsSimpleAdapter(Context context, int layout, Cursor c, FragmentManager fm) {
        ...
        /*prize-Change the background color-lixing -2015-8-5 -- start*/
        prize_account_bg_color = mRes.getColor(R.color.prize_background);
        /*prize-Change the background color-lixing -2015-8-5 -- end*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if ("PC Sync".equals(name)) {
        	String nameLocal = mRes.getString(R.string.event_info_calendar_default_label);
        	calendarName.setText(nameLocal);
		} else {
