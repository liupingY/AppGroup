...
public class AgendaByDayAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
    	...
    	/** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-start */
    	CheckBox dayStatus;
    	/** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-start */
    ...
    public AgendaByDayAdapter(Context context, boolean isMonth) {
        mContext = context;
        isMonthAgenda = isMonth;
        /** prize-update init Agenda by- wanzhijuan-2015-7-8-start */
        if (isMonth) {
        	mAgendaAdapter = new AgendaAdapter(context, R.layout.agenda_item_month);
        } else {
        	mAgendaAdapter = new AgendaAdapter(context, R.layout.agenda_item);
        }
        /** prize-update init Agenda by -wanzhijuan-2015-7-8-end */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row.mType == TYPE_DAY) {
            ...
            if (holder == null) {
                ...
                /** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-start */
                holder.dayStatus = (CheckBox) agendaDayView.findViewById(R.id.agenda_item_status);
                /** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-end */
            ...
            if ((!allDay && row.mEventStartTimeMilli <= System.currentTimeMillis()) ||
            	...
            	/** prize-change_Calendar_agenda_daystatus-wangzhong-20150424-start */
                //itemView.setBackgroundResource(R.drawable.agenda_item_bg_secondary);
            	/** prize-change_Calendar_agenda_daystatus-wangzhong-20150424-end */
            ...
            /** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-start */
            holder.dayStatus.setChecked(!holder.grayed);
            /** prize-add_Calendar_agenda_daystatus-wangzhong-20150424-end */
            
            /** prize-adjust event layout-wanzhijuan-2015-7-8-start */
            int nextPosition = position + 1;
            if (holder.divider != null) {
            	if ((nextPosition >= mRowInfo.size()) || mRowInfo.get(nextPosition).mType == TYPE_DAY) {
