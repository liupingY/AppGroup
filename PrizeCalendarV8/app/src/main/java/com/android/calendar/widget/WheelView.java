...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	private void initData(Context context) {
        ...
        LogUtil.i(TAG, "initData() mTextSize=" + mTextSize);
	}
	...
	private int getDesiredHeight(Layout layout) {
		...
		LogUtil.i(TAG, "getDesiredHeight() itemHeight=" + height + " visibleItems=" + visibleItems + " desired=" + desired);
		// Check against our minimum height
		desired = Math.max(desired, getSuggestedMinimumHeight());
		LogUtil.i(TAG, "getDesiredHeight() after desired=" + desired);
		return desired;
	}
	...
	private String buildText(boolean useCurrentValue) {
		...
		for (int i = currentItem - addItems; i <= currentItem + addItems; i++) {
			if (useCurrentValue || i != currentItem) {
				...
				LogUtil.i(TAG, "buildText() text=" + text);
				if (text != null) {
		...
		LogUtil.i(TAG, "buildText() itemsTextStr=" + itemsTextStr);
		return itemsTextStr;
	}
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (itemsLayout == null || itemsLayout.getWidth() > widthItems) {
			...
			LogUtil.i(TAG, "createLayouts() rect=" + rect);
		} else {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		LogUtil.i(TAG, "onMeasure() width=" + width + " height=" + height);
...
//		ITEMS_TEXT_COLOR;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		LogUtil.i(TAG, "drawCenterRect() height=" + getHeight());
