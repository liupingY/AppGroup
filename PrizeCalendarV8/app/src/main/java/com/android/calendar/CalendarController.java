...
//    private  Time mTime = new Time();
    ...
    public interface EventType {
        ...
        /**prize-calendar-liudong-2016-03-30-start add by update agenda show*/
        final long UPDATE_AGENDA_SHOW_TIME = 1L << 12;
    }
    ...
    public Runnable getmUpdateTimezone() {
        return mUpdateTimezone;
    }
    ...
    public interface EventHandler {
         ...
         */
        void eventsChanged();
        void eventsChanged(Time selectedTime);
    }
...
//        if (event.selectedTime != null && event.selectedTime.toMillis(false) != 0) {
            mTime.set(event.selectedTime);     //removed by hekeyi for calendarV8.0  20171014
        } else {
            /// M: like above
...
//              if (startMillis != 0) {
                ...
                if (event.startTime != null && (mtimeMillis < startMillis
...
//        if (startMillis == 0) {
        ...
        synchronized (this) {
            ...
            if (mFirstEventHandler != null) {
                ...
                if (handler != null && (handler.getSupportedEventTypes() & event.eventType) != 0
                        && !mToBeRemovedEventHandlers.contains(mFirstEventHandler.first) || event.eventType == EventType.UPDATE_AGENDA_SHOW_TIME) {
            ...
            for (Iterator<Entry<Integer, EventHandler>> handlers =
                ...
                if (eventHandler != null
                        && (eventHandler.getSupportedEventTypes() & event.eventType) != 0 /*|| event.eventType == EventType.UPDATE_AGENDA_SHOW_TIME*/) {
     ...
     */
    public long getTime() {
//        mTime.timezone = TimeZone.getDefault().getID();   //add by hekeyi 20171017
    ...
    private void launchSelectVisibleCalendars() {
        ...
        String activityName = mContext.getClass()+"";
        Bundle bundle = new Bundle();
        bundle.putString(Utils.KEY_ACTIVITY_NAME,activityName);
    ...
    private void launchSettingsPrize() {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setClass(mContext, PrizeSettingsActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        mContext.startActivity(intent);
    }
