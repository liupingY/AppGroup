    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        if(null != listView){
            ...
            if (listView instanceof ListView) {
				...
				((ListView)listView).setDivider(divider);
				((ListView)listView).setDividerHeight(1);
				TextView view = new TextView(this);
				view.setLines(0);
				((ListView)listView).addFooterView(view, null, false);
        ...
        if (Utils.getTardis() + DateUtils.MINUTE_IN_MILLIS > System.currentTimeMillis()) {
            ...
            tardisHeader.fragment = "OtherPreferences";
