...
public class AlertAdapter extends ResourceCursorAdapter {
    ...
    public static void updateView(Context context, View view, String eventName, String location,
        ...
        /*PRIZE-modifi pop-up notification style-xiaoping-2016-12-03-start*/
//        TextView whereView = (TextView) view.findViewById(R.id.where);
        TextView pastView = (TextView) view.findViewById(R.id.past_activities);
        if (mFirstTime) {
            mPastEventColor = res.getColor(R.color.alert_past_event);
            mTitleColor = res.getColor(R.color.prize_alert_event_title);
        ...
        if (endMillis < System.currentTimeMillis()) {
            if(pastView!=null){
                ...
                pastView.setTextColor(mPastEventColor);
            }
             if(titleView!=null) titleView.setTextColor(mTitleColor);
            if(whenView!=null) whenView.setTextColor(mPastEventColor);
//            whereView.setTextColor(mPastEventColor);
        } else {
            if(pastView!=null) pastView.setVisibility(View.GONE);
            if(titleView!=null) titleView.setTextColor(mTitleColor);
            if(whenView!=null) whenView.setTextColor(mTitleColor);
//            whereView.setTextColor(mTitleColor);
        }
        ...
        if(titleView!=null) titleView.setText(eventName);
        ...
        when = sb.toString();
        if(whenView!=null) whenView.setText(when);
...
//        }
        ...
        /*PRIZE-modifi pop-up notification style-xiaoping-2016-12-03-end*/
    }
    ...
    /** M: findbugs fix.*/
    private static void setAlertActivity(AlertActivity activity) {
        alertActivity = activity;
    }
}
