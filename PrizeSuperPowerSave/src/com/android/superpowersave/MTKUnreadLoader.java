...
public class MTKUnreadLoader extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (MTK_ACTION_UNREAD_CHANGED.equals(action)) {
			try {
				Method getExtra = intent.getClass().getMethod("getExtra", new Class[] { String.class });
	        	componentName = (ComponentName) getExtra.invoke(intent, new Object[] { MTK_EXTRA_UNREAD_COMPONENT });
			} catch (Exception e) {
				e.printStackTrace();
				return;
			}
