 ...
 * <b>i.e.</b> :
 * <code>new {@link DisplayLargerImageOptions}.Builder().{@link Builder#cacheInMemory() cacheInMemory()}.
 ...
 * @since 1.0.0
 */
public final class DisplayLargerImageOptions {
	...
	private DisplayLargerImageOptions(Builder builder) {
	...
	/**
	 * Builder for {@link DisplayLargerImageOptions}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		 ...
		 * image aware view} during image loading.
		 * This option will be ignored if {@link DisplayLargerImageOptions.Builder#showImageOnLoading(int)} is set.
		 */
		 ...
		 * image aware view} if empty URI (null or empty
		 * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
		 * This option will be ignored if {@link DisplayLargerImageOptions.Builder#showImageForEmptyUri(int)} is set.
		 */
		 ...
		 * image aware view} if some error occurs during
		 * requested image loading/decoding.
		 * This option will be ignored if {@link DisplayLargerImageOptions.Builder#showImageOnFail(int)} is set.
		 */
		...
		public Builder cloneFrom(DisplayLargerImageOptions options) {
		...
		/** Builds configured {@link DisplayLargerImageOptions} object */
		public DisplayLargerImageOptions build() {
			return new DisplayLargerImageOptions(this);
		}
	}
	 ...
	 */
	public static DisplayLargerImageOptions createSimple() {
