...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	final DisplayLargerImageOptions options;
			...
			if (bitmap == null || bitmap.getWidth() <= 0
				...
				if (bitmap != null) {
					if (bitmap.getHeight() < bitmap.getWidth()) {
						JLog.e("huang", "detailFragment="+detailFragment);
						if (detailFragment != null) {
							detailFragment.loadSuccess(bitmap);
						}
					}
				}
			}
	...
	private boolean resizeAndSaveImage(int maxWidth, int maxHeight)
		...
		if (targetFile != null && targetFile.exists()) {
			...
			DisplayLargerImageOptions specialOptions = new DisplayLargerImageOptions.Builder()
					.cloneFrom(options)
