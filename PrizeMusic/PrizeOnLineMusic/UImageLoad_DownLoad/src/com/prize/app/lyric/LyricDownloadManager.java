...
public class LyricDownloadManager {
	...
	public String searchLyricFromWeb(String musicName, String singerName,
			String oldMusicName) {
		JLog.i(TAG, "下载前，歌曲名:" + musicName + ",歌手名:" + singerName);
	...
	private String fetchLyricContent(String musicName, String singerName,
		...
		if (content != null) {
			...
			String savePath = folderPath + File.separator + oldMusicName
					+ ".lrc";
			JLog.i(TAG, "歌词保存路径:" + savePath + "---oldMusicName="
					+ oldMusicName);
	...
	public static void saveLyric(String content, String filePath) {
		...
		try {
			...
			e.printStackTrace();
			JLog.i(TAG, "很遗憾，将歌词写入外存时发生了IO错误");
		}
	}
}
