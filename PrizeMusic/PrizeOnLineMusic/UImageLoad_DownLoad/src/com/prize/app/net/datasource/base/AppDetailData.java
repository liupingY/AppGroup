...
public class AppDetailData extends AbstractNetData implements Serializable {
	...
	public ArrayList<Medias> medias = new ArrayList<Medias>();
	private static final long serialVersionUID = 1L;

	public static class SameFunctionApp implements Serializable {
		public long apkSize;
		...
		public String toString() {
			return "SameCatApp [apkSize=" + apkSize + ", apkSizeFormat="
					+ apkSizeFormat + ", appTypeId=" + appTypeId
					+ ", boxLabel=" + boxLabel + ", categoryName="
					+ categoryName + ", downloadTimes=" + downloadTimes
					+ ", downloadTimesFormat=" + downloadTimesFormat
					+ ", downloadUrl=" + downloadUrl + ", iconUrl=" + iconUrl
					+ ", id=" + id + ", name=" + name + ", packageName="
					+ packageName + ", rating=" + rating + ", updateTime="
					+ updateTime + ", versionCode=" + versionCode
	...
	@Override
	public String toString() {
		return "AppDetailData [app=" + app + ", sameCatApps=" + sameCatApps
				+ "]";
	}
