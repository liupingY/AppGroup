...
import static com.prize.app.constants.Constants.BUILD_DEPENDS;
import static com.prize.app.constants.Constants.BUILD_VERSION;
import static com.prize.app.constants.Constants.DELETE_CACHE;
import static com.prize.app.constants.Constants.WIDGET_STYLE;
...
public class SettingsHolder extends PreferenceActivity implements
		ServiceConnection {
	Context mContext;
		...
		aboutApolloMod
				.setOnPreferenceClickListener(new OnPreferenceClickListener() {
					...
					public boolean onPreferenceClick(final Preference preference) {
						...
						final SpannableString s = new SpannableString(mContext
								.getText(R.string.about_apollomod_message));
						Linkify.addLinks(s, Linkify.WEB_URLS);
						message.setText(s);
						message.setMovementMethod(LinkMovementMethod
								.getInstance());
