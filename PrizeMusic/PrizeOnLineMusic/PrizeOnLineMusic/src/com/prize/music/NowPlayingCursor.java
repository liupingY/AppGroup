...
public class NowPlayingCursor extends AbstractCursor {
	...
	public NowPlayingCursor(IApolloService service, String[] projection,
			Context c) {
	...
	private void makeNowPlayingCursor() {
		...
		mCurrentPlaylistCursor = MusicUtils.query(context,
				Audio.Media.EXTERNAL_CONTENT_URI, mProjection,
				where.toString(), null, BaseColumns._ID);

		if (mCurrentPlaylistCursor == null || mCurrentPlaylistCursor.getCount() <= 0) {
			mSize = 0;
			return;
		}
