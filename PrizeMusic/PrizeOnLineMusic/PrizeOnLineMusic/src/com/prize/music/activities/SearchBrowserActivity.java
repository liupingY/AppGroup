...
public class SearchBrowserActivity extends Activity implements
	...
	private ImageView action_searche;
	...
	private OnItemClickListener listener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if ("artist".equals(selectedType)) {
				...
				bundle.putString(Constants.MIME_TYPE,
						Audio.Artists.CONTENT_TYPE);
				bundle.putString(Constants.ARTIST_KEY, artistName);
				bundle.putLong(BaseColumns._ID, id);
				ApolloUtils.setArtistId(artistName, id, Constants.ARTIST_ID,
				...
				bundle.putLong(BaseColumns._ID, id);
				bundle.putString(Constants.ALBUM_ID_KEY, id + "");
				Intent intent = new Intent(Intent.ACTION_VIEW);
				intent.setClass(SearchBrowserActivity.this, TracksBrowser.class);
				intent.putExtras(bundle);
				startActivity(intent);
	...
	public void onServiceConnected(ComponentName name, IBinder service) {
		...
		if (Intent.ACTION_VIEW.equals(action)) {
			...
			if (path.startsWith("content://media/external/audio/media/")) {
				...
				bundle.putString(Constants.MIME_TYPE,
						Audio.Artists.CONTENT_TYPE);
				bundle.putString(Constants.ARTIST_KEY, uri.getLastPathSegment());
				bundle.putLong(BaseColumns._ID, ApolloUtils.getArtistId(
						uri.getLastPathSegment(), Constants.ARTIST_ID, this));
		...
		action_searche = (ImageView) findViewById(R.id.action_searche);
		...
		action_search_Edtv.addTextChangedListener(new EditChangedListener());
		...
		public void bindView(View view, Context context, Cursor cursor) {
			...
			if (mimetype.equals("artist")) {
				...
				if ((mPlayingId != 0 && mCurrentId != 0)
					...
					peak_two.setImageResource(R.anim.peak_meter_orange);
					...
					try {
						if (MusicUtils.mService != null
							...
							peak_two.setImageResource(R.drawable.icon_play_stop_black);
						}
