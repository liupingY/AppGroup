 ...
 * 关键字歌手结果请求
 */
public class SearchSingerTask extends BaseRequestTask{

    private Handler mHandler;

	public SearchSingerTask(XiamiSDK xiamiSDK, String requestHost) {

		super(xiamiSDK, requestHost);

	}

	public SearchSingerTask(XiamiSDK xiamiSDK, String requestHost, Handler handler) {
		super(xiamiSDK, requestHost);
