 ...
 * @version V1.0
 */
public class BannerTask extends BaseRequestTask {
	private Handler mHandler;

	public BannerTask(XiamiSDK xiamiSDK, String requestHost) {
	...
	public BannerTask(XiamiSDK xiamiSDK, String requestHost, Handler handler) {
		super(xiamiSDK, requestHost);
