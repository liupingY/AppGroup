 ...
 * 关键字歌曲结果请求
 */
public class SearchAlbumTask extends BaseRequestTask{

    private Handler mHandler;

	public SearchAlbumTask(XiamiSDK xiamiSDK, String requestHost) {

		super(xiamiSDK, requestHost);

	}

	public SearchAlbumTask(XiamiSDK xiamiSDK, String requestHost, Handler handler) {
		super(xiamiSDK, requestHost);
