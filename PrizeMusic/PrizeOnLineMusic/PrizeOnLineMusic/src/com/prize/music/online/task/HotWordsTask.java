 ...
 * 请求搜索热词  
 */
public class HotWordsTask extends BaseRequestTask{

    private Handler mHandler;

	public HotWordsTask(XiamiSDK xiamiSDK, String requestHost) {

		super(xiamiSDK, requestHost);

	}

	public HotWordsTask(XiamiSDK xiamiSDK, String requestHost, Handler handler) {
		super(xiamiSDK, requestHost);
