 ...
 * 请求推荐歌手  
 */
public class RecommendSingerTask extends BaseRequestTask{

    private Handler mHandler;

	public RecommendSingerTask(XiamiSDK xiamiSDK, String requestHost) {

		super(xiamiSDK, requestHost);

	}

	public RecommendSingerTask(XiamiSDK xiamiSDK, String requestHost, Handler handler) {
		super(xiamiSDK, requestHost);
