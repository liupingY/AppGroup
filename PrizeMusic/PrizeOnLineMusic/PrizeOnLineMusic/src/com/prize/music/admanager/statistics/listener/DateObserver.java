 ...
 *日期变化监听
 */
public class DateObserver extends BroadcastReceiver {
    /**
     * LOG Tag
     */
    private static final String LOG_TAG = DateObserver.class.getSimpleName();
    /**
     * Context
     */
     ...
     */
    public DateObserver(Context aContext, IDatekListener aListener) {
        mContext = aContext;
        mListener = aListener;
        isRegistered = false;
    }
