...
public class StickyNavLayout extends LinearLayout {
	...
	public StickyNavLayout(Context context, AttributeSet attrs) {
		...
		headHigh=(int) getResources().getDimension(R.dimen.one_six_twopx);
		JLog.i("StickyNavLayout", "headHigh="+headHigh);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		params.height = getMeasuredHeight() - mNav.getMeasuredHeight() - headHigh;
...
//		mTopViewHeight = mTop.getMeasuredHeight() -array.getDimension;
		mTopViewHeight = mTop.getMeasuredHeight() - headHigh;
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(dy) > mTouchSlop) {
				...
				/*
				 * else if (mInnerScrollView instanceof RecyclerView) {
				 * RecyclerView rv = (RecyclerView) mInnerScrollView; if
				 * (!isTopHidden || (!android.support.v4.view.ViewCompat
				 * .canScrollVertically(rv, -1) && isTopHidden && dy > 0)) {
				 * initVelocityTrackerIfNotExists();
				 * mVelocityTracker.addMovement(ev); mLastY = y; return true; }
				 * }
				 */
