 ...
 * @version V1.0
 */
public class BatchEditAdapter extends BaseAdapter {
	...
	public BatchEditAdapter(Context activity) {
		this.context = activity;

		drawable = context.getResources().getDrawable(
				R.drawable.icon_batch_hasdownloaded);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// viewHolder.singer_Tv.setCompoundDrawablePadding(14);
		...
		if (mCheckedStates.get(position)) {
			viewHolder.select_flag_Tv.setBackgroundResource(R.drawable.icon_batch_selected);
		} else {
			viewHolder.select_flag_Tv.setBackgroundResource(R.drawable.icon_batch_unselect);
		}
		return convertView;
	}
