 ...
 *  清除缓存
 * */
public class CleanDataFragment extends DialogFragment {
	 ...
	 *            确认按钮的监听器
	 */
	public static CleanDataFragment newInstance(String title,
			String content, String sure, String cancel,
			View.OnClickListener positiveButtonClickListener) {
		CleanDataFragment f = new CleanDataFragment();
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = inflater.inflate(R.layout.fragment_clean_data, null);
		...
		add_neg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				 CleanDataFragment.this.dismissAllowingStateLoss();
