...
public class XRTextView extends TextView {
	...
	public XRTextView(Context context, AttributeSet attrs) {
		...
		paddingLeft = getResources().getDimension(
				R.dimen.update_text_paddingleft);
		// paddingRight
		// =getResources().getDimension(R.dimen.update_text_paddingleft);
		paddingRight = getResources().getDimension(
				R.dimen.update_text_paddingleft);
