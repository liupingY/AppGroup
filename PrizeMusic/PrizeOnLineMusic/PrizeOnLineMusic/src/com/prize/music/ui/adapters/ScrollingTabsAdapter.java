...
public class ScrollingTabsAdapter implements TabAdapter {
	...
	public View getView(int position) {
		...
		if (BaseApplication.SWITCH_UNSUPPORT) {
			tab = (Button) inflater.inflate(R.layout.oldtabs, null);

			mTitles = activity.getResources()
					.getStringArray(R.array.tab_titles);
		} else {
			tab = (Button) inflater.inflate(R.layout.tabs, null);
			mTitles = activity.getResources().getStringArray(
					R.array.tab_home_titles);
