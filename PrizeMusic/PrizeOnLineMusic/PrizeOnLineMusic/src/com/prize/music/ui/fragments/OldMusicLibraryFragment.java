...
import com.prize.music.ui.adapters.OldScrollingTabsAdapter;
...
public class OldMusicLibraryFragment extends BaseFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		layoutView = inflater.inflate(R.layout.fragment_oldlibrary_browser,
				null);
		findViewById();
		init();
		setListener();
			...
			public void onClick(View v) {
				...
				if (mMeFragment != null && mMeFragment.isAdded()) {
					getActivity().getSupportFragmentManager()
							.beginTransaction()
							.hide(OldMusicLibraryFragment.this)
	...
	public void initScrollableTabs(ViewPager mViewPager) {
		...
		OldScrollingTabsAdapter mScrollingTabsAdapter = new OldScrollingTabsAdapter(
				mainActivity);
