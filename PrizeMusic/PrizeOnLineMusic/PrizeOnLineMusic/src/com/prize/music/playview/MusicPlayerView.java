...
*/
package com.prize.music.playview;
...
//    mPaintButton.setStyle(Paint.Style.FILL);
    ...
    mPaintProgressEmpty.setStrokeWidth(1.0f);
    ...
    mPaintProgressLoaded.setStrokeWidth(3.0f);
...
//    mPaintTime.setTextSize(mTextSize);
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if(width <720){
        ...
        mPlayPauseDrawable.resize((1.2f * mButtonRadius / 8.0f), (3.0f * mButtonRadius / 8.0f) + 10.0f,
            (mButtonRadius / 5.0f));
    }else{
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    //Draw cover image
    float radius = mCenterX <= mCenterY ? mCenterX - 10.0f : mCenterY - 10.0f;   //75
...
//    canvas.drawCircle(mCenterX, mCenterY, mButtonRadius, mPaintButton);
    ...
    if (mProgressVisibility) {
      ...
      canvas.drawArc(rectF, -90, calculatePastProgressDegree(), false, mPaintProgressLoaded);
