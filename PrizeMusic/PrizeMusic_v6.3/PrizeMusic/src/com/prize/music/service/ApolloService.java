...
public class ApolloService extends Service implements
	...
	public void onDestroy() {
		...
		//prize-public-bug:Music is still on while the file has been deleted-pengcancan-20160126-end
		cancelNotification();
		Log.e("LIXING", "Service being destroyed ");
		super.onDestroy();
	}
...
//					stopForeground(true);
	...
	public void cancelNotification(){
        ...
        Log.i("pengcancan", "[cancelNotification]");
	}
	...
	public boolean onUnbind(Intent intent) {
		...
		if (mIsSupposedToBePlaying || mPausedByTransientLossOfFocus) {
			...
			// the service now.
			Log.d("LIXING","onUnbind  mIsSupposedToBePlaying || mPausedByTransientLossOfFocus = true");
			return true;
		}
		...
		if (mPlayListLen > 0 || mMediaplayerHandler.hasMessages(TRACK_ENDED)) {
			Message msg = mDelayedStopHandler.obtainMessage();
			mDelayedStopHandler.sendMessageDelayed(msg, IDLE_DELAY);
			Log.d("LIXING","onUnbind  mPlayListLen > 0 || mMediaplayerHandler.hasMessages(TRACK_ENDED) = true");
			return true;
		}

		// No active playlist, OK to stop the service right now
		Log.d("LIXING","onUnbind  prepare stopSelf");
...
*/			
	...
	public void play() {
		...
		Log.d(TAG,"mPlayer.isInitialized() = " + mPlayer.isInitialized());
		if (mPlayer!=null && mPlayer.isInitialized()) {
