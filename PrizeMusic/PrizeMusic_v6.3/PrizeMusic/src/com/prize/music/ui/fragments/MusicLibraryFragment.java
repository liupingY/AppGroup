...
import static com.prize.music.Constants.TABS_ENABLED;
...
public class MusicLibraryFragment extends BaseFragment implements
			...
			public void onClick(View v) {
				...
				if (mMeFragment != null && mMeFragment.isAdded()) {
					getActivity().getSupportFragmentManager()
							.beginTransaction().hide(MusicLibraryFragment.this)
