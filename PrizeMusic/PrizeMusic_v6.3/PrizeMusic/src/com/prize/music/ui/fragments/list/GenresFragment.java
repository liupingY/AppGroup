...
import com.prize.music.ui.adapters.list.GenreAdapter;
...
public class GenresFragment extends ListViewFragment {
	...
	public void setupFragmentData() {
		mAdapter = new GenreAdapter(getActivity(), R.layout.listview_items,
				null, new String[] {}, new int[] {}, 0);
		mProjection = new String[] { Audio.Genres._ID, Audio.Genres.NAME };
