...
import static com.prize.music.Constants.INTENT_ACTION;
...
public class TracksBrowser extends FragmentActivity implements
	...
	private void findViewById() {
		...
		action_search = (TextView) findViewById(R.id.action_search);
		...
		findViewById(R.id.back_rlyt).setBackgroundDrawable(null);
	...
	private void initPager() {
		...
		// 7/10新需求，歌手进入也要加载图片？
		if (ApolloUtils.isArtist(mimeType)) {
			long artistId = ApolloUtils.getArtistId(getArtist(), ARTIST_ID,
					this);
	...
	private class PageListener extends SimpleOnPageChangeListener {
		...
		public void onPageSelected(int cur) {
			if (cur == 0) {
				// ImageButton mCButton = (ImageButton)
				// findViewById(R.id.view_more);
				// mCButton.setImageResource(R.drawable.view_more_album);
				// String lineTwo =
				// MusicUtils.makeAlbumsLabel(TracksBrowser.this,
				// Integer.parseInt(getNumAlbums()), 0, false);
				...
				// String lineTwo =
				// MusicUtils.makeAlbumsLabel(TracksBrowser.this, 0,
				// Integer.parseInt(getNumSongs()), true);
				half_artist_image_text.setTextColor(getResources().getColor(
						R.color.text_color_gray));
				lineTwoView
