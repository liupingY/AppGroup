 ...
 * {@link GridViewWith#addHeaderView(View, Object, boolean)} See
 * {@link GridViewWith#addFooterView(View, Object, boolean)}
 */
public class GridViewWith extends GridView {
	...
	private class FullWidthFixedViewLayout extends FrameLayout {
		...
		protected void onLayout(boolean changed, int left, int top, int right,
				int bottom) {
			int realLeft = GridViewWith.this.getPaddingLeft()
					+ getPaddingLeft();
