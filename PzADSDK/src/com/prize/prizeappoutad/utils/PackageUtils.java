...
import com.prize.prizeappoutad.utils.ShellUtils.CommandResult;
...
public class PackageUtils {
	 ...
	 * @return
	 */
	// public static final synchronized void installSys(Context context,
	// String filePath, InstallResultCallBack callBack) {
	// installSilentFRSys(context, filePath,
	// BaseApplication.curContext.getPackageName(), callBack);
	// }
	...
	public static synchronized void installSilentFRSys(Context context,
		...
		try {
			...
			pm.installPackage(Uri.fromFile(new File(filePath)),
					new PackageInstallObserver() {
						...
						public void onPackageInstalled(String basePackageName,
							...
							JLog.i(TAG, "installSilentFRSys-msg=" + msg
			...
			JLog.i(TAG, "installSilentFRSys-Exceptione=" + e + "--packageName="
					+ packageName + "--filePath=" + filePath);
			...
			if (e != null && !TextUtils.isEmpty(e.getMessage())) {
				...
				} else if (errorMsg.contains("INSTALL_FAILED_INVALID_APK")) {
					errCode = INSTALL_FAILED_INVALID_APK;
				} else if (errorMsg.contains("INSTALL_FAILED_INVALID_URI")) {
				...
				} else if (errorMsg.contains("INSTALL_FAILED_NO_SHARED_USER")) {
				...
				} else if (errorMsg.contains("INSTALL_FAILED_OLDER_SDK")) {
					errCode = INSTALL_FAILED_OLDER_SDK;
				} else if (errorMsg
						.contains("INSTALL_FAILED_CONFLICTING_PROVIDER")) {
					errCode = INSTALL_FAILED_CONFLICTING_PROVIDER;
				} else if (errorMsg.contains("INSTALL_FAILED_NEWER_SDK")) {
					errCode = INSTALL_FAILED_NEWER_SDK;
				} else if (errorMsg.contains("INSTALL_FAILED_TEST_ONLY")) {
					errCode = INSTALL_FAILED_TEST_ONLY;
				} else if (errorMsg
						.contains("INSTALL_FAILED_CPU_ABI_INCOMPATIBLE")) {
					errCode = INSTALL_FAILED_CPU_ABI_INCOMPATIBLE;
				} else if (errorMsg.contains("INSTALL_FAILED_MISSING_FEATURE")) {
					errCode = INSTALL_FAILED_MISSING_FEATURE;
				} else if (errorMsg.contains("INSTALL_FAILED_CONTAINER_ERROR")) {
				...
				} else if (errorMsg.contains("INSTALL_FAILED_PACKAGE_CHANGED")) {
					errCode = INSTALL_FAILED_PACKAGE_CHANGED;
				} else if (errorMsg.contains("INSTALL_FAILED_UID_CHANGED")) {
