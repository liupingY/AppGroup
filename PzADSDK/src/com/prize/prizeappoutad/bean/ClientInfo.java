...
import com.prize.prizeappoutad.utils.CTelephoneInfo;
...
public class ClientInfo {
	...
	private ClientInfo(Context context) {
		...
		JLog.i("long", "channelCode-->" + channel);
	...
	public static int getAPNType(Context context) {
		...
		JLog.i("ClientInfo", "networkType is " + networkType);
		return netType;
	}
