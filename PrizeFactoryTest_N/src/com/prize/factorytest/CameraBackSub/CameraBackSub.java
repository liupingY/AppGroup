...
public class CameraBackSub extends Activity implements SurfaceHolder.Callback {
	...
	public void surfaceCreated(SurfaceHolder surfaceholder) {
		...
		try {
			mCamera1 = Camera.open(Camera.CameraInfo.CAMERA_FACING_BACK);
			mCamera = Camera.open(Camera.CameraInfo.CAMERA_FACING_FRONT);

			/*prize-qindaohong-20160818-add for Back sub camera  -start */
			Camera.Parameters mParameters = mCamera.getParameters();
			mParameters.setPreviewSize(640, 480);
			mCamera.setParameters(mParameters);
			/*prize-qindaohong-20160818-add for Back sub camera  -end */
