package com.prize.videoc.widget;
 ...
 * See {@link GridViewWith#addHeaderView(View, Object, boolean)}
 * See {@link GridViewWith#addFooterView(View, Object, boolean)}
 */
public class GridViewWith extends GridView {
    ...
    public GridViewWith(Context context) {
        super(context);
        initHeaderGridView();
    }

    public GridViewWith(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public GridViewWith(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = GridViewWith.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = GridViewWith.this.getMeasuredWidth()
                    - GridViewWith.this.getPaddingLeft()
                    - GridViewWith.this.getPaddingRight();
