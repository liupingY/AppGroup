...
import com.prize.prizenavigation.receiver.CompleteReceiver;
import com.prize.prizenavigation.utils.Constants;
import com.prize.prizenavigation.utils.DownloadManagerPro;
...
//		}
	...
	@Override
	public void show() {
		LogUtil.i("bao", "show()" + "---mContext=" + mContext);
	...
	private class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				LogUtil.i("bao", "1.4.2=downing---8:success--16:faile--status="
						+ status);
				if (isDownloading(status)) {
					...
					if (msg.arg2 < 0) {
						...
						LogUtil.i("bao", "1	downloadProgress.setMax(msg.arg2)");
