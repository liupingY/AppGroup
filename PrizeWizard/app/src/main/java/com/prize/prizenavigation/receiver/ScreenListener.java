...
import com.prize.prizenavigation.service.PrizeNavigationService;
...
//			JLog.i("ScreenListener", "currentLevel=" + currentLevel
...
//			JLog.i("hu", "action=" + action.toString());
			if (Intent.ACTION_SCREEN_ON.equals(action)) { // 开屏
				isScreenoff = false;
				mScreenStateListener.onScreenOn();
				PollMgr.stopPollingService(context,
						PrizeNavigationService.class, action);
