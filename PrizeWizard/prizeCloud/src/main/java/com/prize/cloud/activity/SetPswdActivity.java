...
public class SetPswdActivity extends BaseActivity {
	...
	private void findViewById() {
		mPswdEdit = (EditText) findViewById(R.id.password_id);
		mConfirmEdit = (EditText) findViewById(R.id.confirm_password_id);
		mCommitBtn = (TextView) findViewById(R.id.confirmtn_id);
	}
