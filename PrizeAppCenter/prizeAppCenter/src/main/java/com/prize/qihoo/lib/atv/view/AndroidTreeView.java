package com.prize.qihoo.lib.atv.view;
...
import com.prize.qihoo.lib.atv.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    public View getView(int style) {
        ...
        if (style > 0) {
            ...
            view = use2dScroll ? new com.prize.qihoo.lib.atv.view.TwoDScrollView(newContext) : new ScrollView(newContext);
        } else {
            view = use2dScroll ? new com.prize.qihoo.lib.atv.view.TwoDScrollView(mContext) : new ScrollView(mContext);
        }
