package com.prize.qihoo.lib.atv.model;
...
public class TreeNode {
    ...
    public static abstract class BaseNodeViewHolder<E> {
        protected com.prize.qihoo.lib.atv.view.AndroidTreeView tView;
        ...
        public View getView() {
            ...
            final com.prize.qihoo.lib.atv.view.TreeNodeWrapperView nodeWrapperView = new com.prize.qihoo.lib.atv.view.TreeNodeWrapperView(nodeView.getContext(), getContainerStyle());
        ...
        public void setTreeViev(com.prize.qihoo.lib.atv.view.AndroidTreeView treeViev) {
            this.tView = treeViev;
        }

        public com.prize.qihoo.lib.atv.view.AndroidTreeView getTreeView() {
            return tView;
        }
