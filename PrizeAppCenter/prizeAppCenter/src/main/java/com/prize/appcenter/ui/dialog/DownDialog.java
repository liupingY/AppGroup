 ...
 * @version V1.0
 */
public class DownDialog extends AlertDialog implements OnClickListener {
	private Button add_neg;
	private Button sureBtn;
	public final int CANCEL = 0;
	public final int SURE = 1;

	public DownDialog(Context context, int theme) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		content_tv.setText(R.string.toast_tip_download_only_wifi);
		...
		add_neg.setText(R.string.download_after);
		sureBtn = (Button) findViewById(R.id.sure_Btn);
		sureBtn.setText(R.string.now_download);
