 ...
 * 及时搜索头布局item
 */
public class HeadSearchItem extends RelativeLayout {
     ...
     * @param layoutId 布局id
     */
    public HeadSearchItem(Context context, int layoutId) {
        super(context);
        mContext = context;
...
//                                PrizeStatUtil.onClickBackParams(itemBean.backParams, itemBean.name, itemBean.packageName);
    ...
    public HeadSearchItem(Context context, AttributeSet attrs, int defStyleAttr) {
