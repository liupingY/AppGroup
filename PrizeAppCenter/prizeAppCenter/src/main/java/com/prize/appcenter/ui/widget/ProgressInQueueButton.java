 ...
 * @author prize
 */
public class ProgressInQueueButton extends ProgressBar {
    /**
     * 进度条画笔
     */
...
//    private static Drawable installGiftPressBG = null;
    ...
    public ProgressInQueueButton(Context context) {
        super(context);
        initPaint(context);
    }

    public ProgressInQueueButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint(context);
    }

    public ProgressInQueueButton(Context context, AttributeSet attrs, int defStyle) {
