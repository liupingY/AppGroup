...
public class Attributes {
	...
	public static int DEFAULT_THEME = 100;
	...
	/**
	 * Attribute change listener. Used to redraw the view when attributes are
	 * changed.
	 */
	...
	public void setThemeSilent(int theme, Resources resources) {
		try {
			...
			// setting theme blood if exception occurs (especially used for
			// preview rendering by IDE)
			colors = new int[] { Color.parseColor("#732219"),
					Color.parseColor("#a63124"), Color.parseColor("#d94130"),
	...
	public void setFontExtension(String fontExtension) {
		if (fontExtension != null && !fontExtension.equals("")
				&& !fontExtension.equals("null"))
	...
	public float[] getOuterRadius() {
		return new float[] { radius, radius, radius, radius, radius, radius,
				radius, radius };
	}
