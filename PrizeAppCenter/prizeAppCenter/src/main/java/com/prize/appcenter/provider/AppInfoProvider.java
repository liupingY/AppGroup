...
package com.prize.appcenter.provider;
...
public class AppInfoProvider extends ContentProvider {
	...
	private static final String AUTHORITY = "com.prize.appcenter.provider.appstore";
	public static final String TABLE_DOWNLOAD_PATH = "content://com.prize.appcenter.provider.appstore/table_downLoaded";
	...
	static {
		...
		sUriMatcher.addURI(AUTHORITY, "table_downLoaded", DOWNLOADED);
		sUriMatcher.addURI(AUTHORITY, "table_downLoaded" + "/*", DOWNLOADED);
