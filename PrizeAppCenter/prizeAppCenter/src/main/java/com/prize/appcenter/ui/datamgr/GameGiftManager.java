...
public class GameGiftManager extends AbstractDataManager {
	...
	public GameGiftManager(DataManagerCallBack callback, String appType) {
		super(callback);
	...
	private DataManagerListener<PrizeAppsTypeData> gameListListener = new DataManagerListener<PrizeAppsTypeData>() {
		...
		protected Message onSuccess(int what, PrizeAppsTypeData data) {
			return Message
					.obtain(GameGiftManager.this, SUCCESS_LIST_PAGE, data);
		}
