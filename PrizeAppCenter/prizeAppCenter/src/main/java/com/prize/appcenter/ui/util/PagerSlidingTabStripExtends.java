...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
    ...
    public PagerSlidingTabStripExtends(Context context, AttributeSet attrs,
        ...
        /*--------------- add begin ---------------*/
        tabsContainer.setHorizontalGravity(Gravity.CENTER_HORIZONTAL);
        tabsContainer.setVerticalGravity(Gravity.CENTER_VERTICAL);
        // tabsContainer.setDividerPadding(R.dimen.progressbar_margin_right);
        /*--------------- add end ---------------*/
...
//		tabTextColor = a.getColor(1, tabTextColor);
        tabTextSize = a.getDimensionPixelSize(android.R.styleable.TextAppearance_textSize, tabTextSize);
        tabTextColor = a.getColor(android.R.styleable.TextAppearance_textColor, tabTextColor);
        a.recycle();
        ...
        indicatorHeight = a.getDimensionPixelSize(
                ...
                indicatorHeight);
        dimension = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pstsTabUnderline_lenth,
                dimension);
...
//    public void setTabsContainer(ViewPager pager) {
//        tabsContainer.setPadding();
//    }
...
//        if (JLog.isDebug) {
//            JLog.i("PagerSlidingTabStripExtends", "addTab-tabPadding=" + tabPadding);
//        }
...
//        float dimension = mContext.getResources().getDimension(
//                R.dimen.title_underline_lenth);
//        float left = currentTab.getLeft();
//        float right = currentTab.getRight();
//        if (JLog.isDebug) {
//            JLog.i("PagerSlidingTabStripExtends", "dimension-" + dimension);
//        }
        float left = lineLeft + (lineRight - lineLeft) / 2 - dimension;
        float right = lineLeft + (lineRight - lineLeft) / 2 + dimension;
        canvas.drawRect(left, height - indicatorHeight, right, height,
                rectPaint);
        // Path path = new Path();
        //
