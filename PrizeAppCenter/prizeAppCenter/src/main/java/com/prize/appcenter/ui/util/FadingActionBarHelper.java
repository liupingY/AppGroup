...
public class FadingActionBarHelper {
	...
	public FadingActionBarHelper(final Context context, final Window window,
	...
	public FadingActionBarHelper(final Context context, final Window window,
			final View actionBar, final Drawable drawable,
			final AppsItemBean itemData, boolean isMostBeautiful) {
		mActionBar = actionBar;
		mWindow = window;
	...
	public void setActionBarAlpha(int alpha) {
		...
		if (!isAlphaLocked) {
			...
			if (mActionBar != null) {
				...
				if (alpha >= 250) {
//					if ( (itemData != null && !TextUtils.isEmpty(itemData.bannerUrl))) {
//
//						mActionBar.findViewById(R.id.action_bar_back)
//								.setBackgroundResource(
//										R.drawable.action_bar_back_selector);
//						mActionBar.findViewById(R.id.action_bar_search)
//								.setBackgroundResource(
//										R.drawable.action_bar_search_selector);
//						mActionBar
//								.findViewById(R.id.action_go_downQueen)
//								.setBackgroundResource(
...
//						mActionBar.findViewById(R.id.action_go_downQueen)
//								.setBackgroundResource(
