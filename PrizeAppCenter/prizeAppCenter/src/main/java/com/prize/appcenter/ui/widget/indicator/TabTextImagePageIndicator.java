 ...
 */
public class TabTextImagePageIndicator extends HorizontalScrollView implements
		PageIndicator {
	...
	private boolean isLayoutWeight = true;// 判断是否平均显示
	...
	public TabTextImagePageIndicator(Context context) {
		this(context, null);
	}
	...
	public TabTextImagePageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void addTab(int index, CharSequence text, int iconID,
			boolean showLine) {
		...
		View view = LayoutInflater.from(getContext()).inflate(
				R.layout.item_pager_title, null);
	...
	public void notifyDataSetChanged() {
		...
		IconTextPagerAdapter iconAdapter = null;
		if (adapter instanceof IconTextPagerAdapter) {
			iconAdapter = (IconTextPagerAdapter) adapter;
		}
