...
public class NoTopicItem extends LinearLayout {
    ...
    public NoTopicItem(Context context) {
        super(context);
        mContext = context;
        setOrientation(VERTICAL);
        setGravity(Gravity.CENTER);
        View view = inflate(context, R.layout.card_item_notopic_view, this);
        findViewById(view);
    }

    public NoTopicItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setOrientation(VERTICAL);
        View view = inflate(context, R.layout.card_item_notopic_view, this);
    ...
    public NoTopicItem(Context context, AttributeSet attrs, int defStyleAttr) {
