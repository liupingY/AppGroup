 ...
 * Created by long
 */
public class PrizeNetworkObserver extends BroadcastReceiver {
    /**
     * LOG Tag
     */
    private static final String LOG_TAG = PrizeNetworkObserver.class.getSimpleName();
    /**
     * Context
     */
     ...
     */
    public PrizeNetworkObserver(Context aContext, INetworkListener aListener) {
        mContext = aContext;
        mListener = aListener;
