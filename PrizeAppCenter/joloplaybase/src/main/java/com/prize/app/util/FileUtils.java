...
public class FileUtils {
	/*** SD卡根目录 */
	private final static String CFG_PATH_SDCARD = Environment
			.getExternalStorageDirectory().getAbsolutePath();
	/*** 应用中心的 SD卡根目录 */
	private final static String CFG_PATH_SDCARD_DIR = CFG_PATH_SDCARD
			+ File.separator + "prizeAppCenter";
//	/*** SD卡上image目录 */
//	public final static String CFG_PATH_SDCARD_PRIZE_IMAGE = CFG_PATH_SDCARD_DIR
//			+ File.separator + "image";
	/*** SD卡上download目录 */
	private final static String CFG_PATH_SDCARD_DOWNLOAD_DIR = CFG_PATH_SDCARD_DIR
...
//	/*** SD卡上log目录 */
//	private final static String LOG_URL = CFG_PATH_SDCARD_DIR
...
//	}
	 ...
	 * @return  下载增量包路径
	 */
	public static String getPatchFilePath(String gameCode) {
		return CFG_PATH_SDCARD_DOWNLOAD_DIR + File.separator + gameCode
				+ ".patch";
	}
