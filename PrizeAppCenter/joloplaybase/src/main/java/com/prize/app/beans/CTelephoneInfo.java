...
//	}
    ...
    void setCTelephoneInfo(String channel) {
        ...
        if (JLog.isDebug) {
            JLog.i("ClientInfo", "setCTelephoneInfo---telephonyManager.getDeviceId() imei=" + CTelephoneInfo.imeiSIM1);
        }
...
//			}
            CTelephoneInfo.imeiSIM1 = getOperatorBySlot(mContext,
                    "getDeviceIdGemini", 0);
            if (JLog.isDebug) {
                JLog.i("ClientInfo", "setCTelephoneInfo---getOperatorBySlot imei1=" + CTelephoneInfo.imeiSIM1);
            }
            CTelephoneInfo.imeiSIM2 = getOperatorBySlot(mContext,
                    "getDeviceIdGemini", 1);
            if (JLog.isDebug) {
                JLog.i("ClientInfo", "setCTelephoneInfo---getOperatorBySlot imei2=" + CTelephoneInfo.imeiSIM2);
            }
