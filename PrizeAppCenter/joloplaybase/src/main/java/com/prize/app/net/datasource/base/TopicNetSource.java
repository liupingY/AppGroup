 ...
 * 
 */
public class TopicNetSource
		extends
		AppAbstractNetSource<PrizeTopicTypeData, Map<String, String>, GetGameListResp> {
	 ...
	 * @param topicId
	 */
	public TopicNetSource(String appTypeId, String topicId) {
	...
	public String getUrl() {
		return Constants.GIS_URL + "/topic/list";// 首页推荐
	}
	...
	@Override
	protected PrizeTopicTypeData parseStrResp(String resp) {
		PrizeTopicTypeData bean = new Gson().fromJson(resp,
				PrizeTopicTypeData.class);
