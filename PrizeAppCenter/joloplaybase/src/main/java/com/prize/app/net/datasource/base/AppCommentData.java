 ...
 * @version 版本
 */
public class AppCommentData extends AbstractNetData implements Serializable {
	...
	public static class AppComment implements Serializable {
		...
		public String toString() {
			return "AppComment [id=" + id + ", nickName=" + nickName + ", nickName=" + showName
					+ ", appId=" + appId + ", versionName=" + versionName
					+ ", mobile=" + mobile + ", nickName=" + model + ", starLevel=" + starLevel
