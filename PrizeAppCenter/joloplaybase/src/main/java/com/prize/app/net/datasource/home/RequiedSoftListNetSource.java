...
public class RequiedSoftListNetSource extends SimpleAppNetSource {
	 ...
	 * @param isGame
	 */
	public RequiedSoftListNetSource(String appType, boolean isGame) {
	...
	public String getUrl() {
		...
		return Constants.GIS_URL + "/topic/need";
	}
