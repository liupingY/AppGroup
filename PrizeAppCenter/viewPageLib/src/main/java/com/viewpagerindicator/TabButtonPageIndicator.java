...
/**
 * tab处显示的是Button This widget implements the dynamic action bar tab behavior
 * that can change across different configurations or circumstances.
 */
public class TabButtonPageIndicator extends HorizontalScrollView implements
		PageIndicator {
	...
	public TabButtonPageIndicator(Context context) {
		this(context, null);
	}

	public TabButtonPageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 *            ： 选中，未选中的字体颜色
	 */
	public void setButtonParams(float txtSize, ColorStateList colors) {
		textSize = txtSize;
		textColors = colors;
	}
